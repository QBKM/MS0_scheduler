...
void routine_deploy(void)
{
    ...
    if(RECOVERY.ADC.GLOBAL == true)
    {
        ...
        else
        {
            ...
            if(reverse_M1.time_ref <= (reverse_M1.time_stamp + REVERSE_DELAY)) 
            {
        ...
        else
        {
            ...
            if(reverse_M2.time_ref <= (reverse_M2.time_stamp + REVERSE_DELAY))
            {
    ...
    //}
    //
    //if(monitoring_current() == true)
    //{
    //    // stop the motors
    //    // uart => stop motor
    //    broadcast_uart_send(MSG_ID_recsys_stop_motor);
    //
    //    // check the FDC
    //    if(capteur_FDC() == true)
    //    {
    ...
    //        broadcast_uart_send(MSG_ID_recsys_unlocked);
    //    }
    //    if(capteur_FDC() == false)
    //    {
    //        // reverse motor for 500 ms
    //        broadcast_uart_send(MSG_ID_recsys_reverse);
    //    }
    //}
